...
},{"./CharMessenger.js":75,"./fetchJSON.js":77,"lodash/core":52,"lodash/template":71,"whatwg-fetch":74}],77:[function(require,module,exports){
require('whatwg-fetch');

var fetchJSON = {};

fetchJSON.form = function(url, formData){
	return fetch(url, {
		method: "post",
		body: formData,
		credentials: "include"
